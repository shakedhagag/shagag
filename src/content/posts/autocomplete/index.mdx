...
*A quick explanation about the empty object type
If we want to define an empty object (not sure when you would need it but ok) we can do something like this:*
```ts

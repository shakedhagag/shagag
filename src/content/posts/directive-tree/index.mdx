...
<br/>
If you have ever searched for something related to modern frontend development, you have probably come across [Theo](https://www.youtube.com/@t3dotgg/videos), an awesome content creator I've been following for a long time. <br/> Last week he published a video called "React's most dangerous feature" where he talks about, and showcases, some concerning security issues with the 'use server' directives.
...
<Image src="https://raw.githubusercontent.com/shakedhagag/directive-tree/main/resources/example.png" alt="example" width="300" height="300"/>

### Find Unused Server Actions
<Image src="https://raw.githubusercontent.com/shakedhagag/directive-tree/main/resources/example2.png" alt="example" width="750" height="550"/>
